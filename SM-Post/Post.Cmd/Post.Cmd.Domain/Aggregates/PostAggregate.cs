...
public class PostAggregate:AggregateRoot
{
    ...
    public void EditMessage(string message)
    {
        ...
        {
            throw new InvalidOperationException($"The value of {nameof(message)} cannot be empty or null!. Please provide a valid {nameof(message)}");
        }
    ...
    public void AddComment(string comment, string username)
    {
        ...
        {
            throw new InvalidOperationException($"The value of {nameof(comment)} cannot be empty or null!. Please provide a valid {nameof(comment)}");
        }
    ...
    public void DeletePost(string username)
    {
        ...
        {
            throw new InvalidOperationException("You are not allowed to delete a comment of an inactive post!");
        }
